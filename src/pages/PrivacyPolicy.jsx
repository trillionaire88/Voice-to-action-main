      ...
      <article className="bg-white border border-slate-200 rounded-2xl shadow-sm p-6 sm:p-10 space-y-8">
        ...
        <Section title="4. How We Collect Your Information">
          <ul className="list-disc pl-6 space-y-1">
            ...
            <li>From third party services including Stripe (payments and identity verification), Supabase Auth (email and phone OTP where enabled), and Resend (transactional email delivery)</li>
          </ul>
        </Section>
        ...
        <Section title="5. How We Use Your Information">
          <ul className="list-disc pl-6 space-y-1">
            ...
            <li>Send you email and phone verification codes when you enable phone sign-in</li>
        ...
        <Section title="7. Who We Share Your Information With">
          ...
          <ul className="list-disc pl-6 space-y-1">
            ...
            <li>Resend — transactional email delivery (United States, with adequate privacy protections)</li>
        ...
        <Section title="9. How We Protect Your Information">
          <ul className="list-disc pl-6 space-y-1">
            ...
            <li>
              Direct message content is encrypted for storage and transmission. This is not independent
              end-to-end encryption where only you hold cryptographic keys outside our systems; do not
