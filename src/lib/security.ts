export function lockPrototypes(): void {
  // Only freeze Object.prototype to prevent prototype-pollution attacks.
  // Freezing Array/Function prototypes risks breaking third-party libraries
  // that add utility methods to those prototypes at runtime.
  try {
    Object.freeze(Object.prototype);
  } catch {
    // noop — already frozen or strict-mode restriction
  }
}
